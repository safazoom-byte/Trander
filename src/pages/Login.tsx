    ...
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground">
      <div className="w-full max-w-md p-10 bg-card rounded-3xl border border-border shadow-sm text-center">
        ...
        <button 
          ...
          className="w-full py-4 px-4 bg-accent border border-border text-foreground rounded-2xl font-bold hover:bg-muted transition-colors flex items-center justify-center gap-3 shadow-sm"
        >
